  ...
  openModelStatus() {
    this.setState({ view: 'models', modelPageTab: 'overview', modelOverviewWindow: '1h', modelOverviewStart: '', modelOverviewEnd: '', modelQuery: '', modelProvider: '', modelModel: '', modelLine: '', modelFilter: 'production', modelBusinessOnly: false, modelSort: 'impact', modelTimeRange: 'all', modelTimeStart: '', modelTimeEnd: '', modelSelection: '', modelRoute: '', modelDrawerMode: '', modelChartMetric: 'ttft', modelTestResult: false, modelRiskDismissed: false });
